...
REM ===========================================================================
REM inspect-po.bat — run the read-only Purchase Order inspector on the server.
REM
REM The AutoCount credentials live in the OMService service configuration, not
REM in your command prompt, so running "node inspect-po.js" on its own fails
...
REM   inspect-po.bat "SZEN 140051111"
REM ===========================================================================
...
if not defined AUTOCOUNT_DB_SERVER (
  ...
  echo Set them by hand instead, then run: node inspect-po.js %1
